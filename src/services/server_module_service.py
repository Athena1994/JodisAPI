...
from model.manager.server_module_manager import ServerModuleManager
from model.server_module import ServerModule

from jodiscore.server.module.module_control import ModuleControl
from jodiscore.server.module.datatypes.state import State
        ...
        with self._sm.create_session() as session:
            for module_file in module_files:
                ...
                if not ServerModuleManager.exists(session, mc.id):
                    sm: ServerModule = ServerModuleManager.create(session, mc)
